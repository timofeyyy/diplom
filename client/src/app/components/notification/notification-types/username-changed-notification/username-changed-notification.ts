...
@Component({
  selector: 'app-username-changed-notification',
  imports: [TimeAgoPipe],
  templateUrl: './username-changed-notification.html',
  styleUrl: './username-changed-notification.css',
})
export class UsernameChangedNotification implements OnInit, OnDestroy {
  @Input()
