...
// сделать метод который бы по айдишнику вытягивал всю информацию о пользователе
// сделать метод который бы по айдишнику вытягивал информацию только необходимую для предварительного просмотра